...
<body>
	<div>
        ...
        $user=mysqli_fetch_array($us);?><a class="nav-links-sub" href="profile.php"><?php echo $user['name'];?></a><a class="nav-links-sub" href="membership.php">Membership</a><a class="nav-links-sub" href="logout.php">Logout</a><?php }else{?><a class="nav-links-sub" href="login.php">Login</a> <a class="nav-links-sub" href="registration.php">Register</a><?php }?></li>
		</ul>
	</div>
